(function createPortfolioI18n(root, factory) {
  ...
  const translations = {
    'zh-CN': {
      ...
      'progress.label': '网站建设进度：50%',
      'progress.text': '网站建设中 <b>50%</b>',
      'progress.close': '关闭建设日志',
      'progress.eyebrow': '00.30 / 建设日志',
      'progress.title': '仍在<br /><i>建设中</i>',
      'progress.current.title': '当前更新',
      'progress.current.bilingual': '中英文内容切换、响应式像素场景、动效控制和研究证据展示已上线。',
      'progress.current.scene': '新增两处互动彩蛋：树木的星光雨，以及 Saber 的主题曲。',
      'progress.current.timeOfDay': '页面现已根据本地时间切换白天与夜晚主题；白天背景使用单色像素树叶。',
      ...
      'ophthalmic.case6.title': '眼底事件相机实验项目',
      ...
      'ophthalmic.case6.label': '眼底事件相机实验项目，待建立',
